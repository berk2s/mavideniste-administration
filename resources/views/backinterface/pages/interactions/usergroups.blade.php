...
@section('title', 'Maviden İste - Kullanıcı grupları')

@section('page_navigation')
    <li class="breadcrumb-item"><a href="javascript:void(0);">Etkileşim</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>Kullanıcı grupları</span></li>
@endsection
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Kullanıcı grupları
                                    <div id='loadingSpin' class="spinner-border text-success align-self-center loader-sm" style="display:none;float:left;width:20px;height:20px"></div>
...
@section('footer_addons')
    ...
    <script src="/mod/js/interactions/usergroups.js"></script>
