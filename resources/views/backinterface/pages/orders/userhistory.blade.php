...
@section('title', 'Maviden İste - Geçmiş sipariş')

@section('page_navigation')
    <li class="breadcrumb-item"><a href="javascript:void(0);">Siparişler</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>Geçmiş sipariş</span></li>
@endsection
                    ...
                    <div class="invoice-container">
                        <div class="invoice-inbox">
                            ...
                            <div class="inv-not-selected">
                                @if(count($results->data) != 0) <p>{{$result->user[0]->name_surname}} üyesinin geçmiş siparişleri</p> @endif
                                @if(count($results->data) == 0)    <p>Geçmiş siparişleri yok</p> @endif
                            </div>
