...
@section('title', 'Maviden İste - Kampanya listesi')
...
@section('content')
    ...
    <div id="fadeinModal" class="modal animated fadeInDown" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" >
                    <h5 class="modal-title" id="edit_categoryName">Kampanya düzenle
                                ...
                                <form id="EditCategoryForm" class="w-100" enctype="multipart/form-data" method="post">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="degree2">Kampanya adı</label>
                                            <input type="text" class="form-control mb-4" id="EDIT_campaignname" value="">
                                        </div>
                                        <div class="form-group">
                                            <label for="degree2">Kampanya kısa açıklaması</label>
                                            <input type="text" class="form-control mb-4" id="EDIT_campaignshortdesc" value="">
                                        </div>
                                        <div class="form-group">
                                            <label for="degree2">Kampanya tipi</label>
                                            <select class="form-control" id="EDIT_campaigntype" onchange="handleChangeType(this)">
                                                <option value="0">Standart</option>
                                                <option value="1">Açıklamalı</option>
                                            </select>
                                        </div>
                                        <div class="form-group" id="campaignDescArea"  style="display: none">
                                            <label for="degree2">Kampanya açıklaması</label>
                                            <textarea class="form-control" style="height:200px" id="EDIT_campaigndesc"></textarea>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Vazgeç</button>
                    <button type="button" id='EDIT_save' onclick="clickHandleCampaignSave(this)" class="btn btn-primary">
                        Kaydet</button>
                </div>
            </div>
        </div>
...
@section('footer_addons')
    ...
    <script src="/mod/js/campaign/list.js"></script>
