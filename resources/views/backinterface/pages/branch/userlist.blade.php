        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" >
                    <h5 class="modal-title" id="edit_categoryName">SMS gönder <small id="userNameText"></small>
                                ...
                                <form id="CreateGroupForm" class="w-100" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" style="height:200px" id="sendSMS_Desc"></textarea>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="saveSendSMS" onclick="clickSendSMS(this)" class="btn btn-primary">Yolla</button>
                </div>
            </div>
        </div>
    </div>
...
@section('footer_addons')
    ...
    <script src="/mod/js/branch/userlist.js"></script>
