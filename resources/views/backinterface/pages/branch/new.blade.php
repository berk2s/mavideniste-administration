...
@section('title', 'Maviden İste - Bayi ekle')

@section('page_navigation')
    <li class="breadcrumb-item"><a href="javascript:void(0);">Bayi</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>Bayi ekle</span></li>
@endsection
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" name="branch_name" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" oninput="checkNumeric(this)" name="branch_committee" value="">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($provinces as $province)
                                                                <option value="{{$province->id}}" id="branchProvince_{{$province->id}}">{{$province->il_adi}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
...
@section('footer_addons')
    ...
    <script src="/mod/js/branch/new.js"></script>
