...
@section('page_navigation')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>Operatör düzenle</span></li>
@endsection
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" name="operator_name" value="{{$user->user_name}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" name="operator_email" value="{{$user->email}}">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="degree2">Şifre değiştir</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" oninput="checkNumeric(this)" class="form-control mb-4" name="operator_phone"  value="{{$user->user_phone}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-4" name="operator_address" value="{{$user->user_address}}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="branch" id="branchSelect">
                                                                @foreach($branchies as $branch)
                                                                    <option value="{{$branch->branch_id}}" {{ $user->user_branch == $branch->branch_id ? 'selected' : '' }}>{{$branch->branch_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            @php
                                                                $userauths = array_column(json_decode($user->user_authority, true), 'page_id');
                                                            @endphp
                                                            <select class="form-control basic" name="authority[]" id="authoritySelect" multiple>
                                                                @foreach($authorities as $authority)
                                                                    <option value="{{$authority->page_id}}" {{array_search($authority->page_id, $userauths) == true ? 'selected' :  ''}}>{{$authority->desc}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
